...
public class Event_tabs extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            startActivity(new Intent(Event_tabs.this,About.class));
        }
    ...
    public void onBackPressed() {
        startActivity(new Intent(Event_tabs.this,MainActivity.class));
    }
}
